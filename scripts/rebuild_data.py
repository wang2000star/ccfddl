...
['cvpr','CVPR',2026,1,'2025-11-13','2025-11-07','2026-01-22','2026-01-29','2026-02-20','','2026-06-11','2026-06-15','Nashville, TN, USA','https://cvpr.thecvf.com/Conferences/2026/','AoE'],
...
['isca','ISCA',2026,1,'2025-11-17','2025-11-10','2026-02-16','2026-03-06','2026-03-27','','2026-06-27','2026-07-01','Raleigh, NC, USA','https://www.iscaconf.org/isca2026/','AoE'],
['fast','FAST',2026,1,'2025-03-18','','2025-05-20','2025-05-22','2025-06-05','2025-07-29','2026-02-24','2026-02-26','Santa Clara, CA, USA','https://www.usenix.org/conference/fast26/','AoE'],
['fast','FAST',2026,2,'2025-09-16','','2025-11-18','2025-11-20','2025-12-08','2026-01-27','2026-02-24','2026-02-26','Santa Clara, CA, USA','https://www.usenix.org/conference/fast26/','AoE'],
['nsdi','NSDI',2026,1,'2025-04-25','2025-04-18','','','2025-07-24','2025-10-21','2026-05-04','2026-05-06','Renton, WA, USA','https://www.usenix.org/conference/nsdi26/','US PDT'],
['nsdi','NSDI',2026,2,'2025-09-18','2025-09-11','','','2025-12-09','2026-03-05','2026-05-04','2026-05-06','Renton, WA, USA','https://www.usenix.org/conference/nsdi26/','US PDT'],
['hpca','HPCA',2026,1,'2025-08-01','2025-07-25','2025-10-07','2025-10-20','2025-11-07','2025-12-04','2026-02-25','2026-03-01','Sydney, Australia','https://hpca-conf.org/','AoE'],
['sigmod','SIGMOD',2026,1,'2025-01-17','2025-01-10','','','2025-05-02','','2026-05-31','2026-06-05','Bengaluru, India','https://2026.sigmod.org/','AoE'],
['sigmod','SIGMOD',2026,2,'2025-04-17','2025-04-10','','','2025-08-01','','2026-05-31','2026-06-05','Bengaluru, India','https://2026.sigmod.org/','AoE'],
['sigmod','SIGMOD',2026,3,'2025-07-17','2025-07-10','','','2025-11-01','','2026-05-31','2026-06-05','Bengaluru, India','https://2026.sigmod.org/','AoE'],
['sigmod','SIGMOD',2026,4,'2025-10-17','2025-10-10','2025-12-01','2025-12-08','2026-01-30','','2026-05-31','2026-06-05','Bengaluru, India','https://2026.sigmod.org/','AoE']],
...
['emnlp','EMNLP',2026,1,'2026-05-25','','','','2026-08-20','','2026-10-24','2026-10-29','Budapest, Hungary','https://2026.emnlp.org/','AoE'],
['ijcai','IJCAI',2026,1,'2026-01-19','','','','2026-04-15','','2026-08-15','2026-08-21','Bremen, Germany','https://ijcai-26.org/','AoE'],
['kdd','KDD',2026,1,'2026-02-08','2026-02-01','2026-04-04','2026-04-17','2026-05-16','2026-06-01','2026-08-09','2026-08-13','Jeju, South Korea','https://kdd2026.kdd.org/','AoE'],
['focs','FOCS',2026,1,'2026-04-01','','','','2026-07-03','','2026-11-08','2026-11-11','New York, NY, USA','https://focs.computer.org/2026/','AoE'],
['siggraph','SIGGRAPH',2026,1,'2026-01-15','','','','2026-03-01','','2026-07-19','2026-07-23','Los Angeles, CA, USA','https://siggraph2026.nnja.co/','AoE'],
['uist','UIST',2026,1,'2026-03-31','2026-03-24','','','2026-08-07','','2026-11-02','2026-11-05','Detroit, MI, USA','https://uist.acm.org/2026/','AoE'],
['miccai','MICCAI',2026,1,'2026-02-26','2026-02-12','','','2026-05-01','2026-06-26','2026-10-04','2026-10-08','Abu Dhabi, UAE','https://conferences.miccai.org/2026/','US Pacific'],
['sc','SC',2026,1,'2026-04-08','2026-04-01','2026-06-08','2026-06-11','2026-07-01','2026-08-28','2026-11-15','2026-11-20','Chicago, IL, USA','https://sc26.supercomputing.org/','AoE'],
['vldb','VLDB',2026,1,'2026-04-01','','','','2026-05-15','','2026-08-31','2026-09-04','Boston, MA, USA','https://vldb.org/2026/','AoE'],
['sosp','SOSP',2026,1,'2026-04-01','2026-03-26','','','2026-07-03','2026-08-28','2026-09-29','2026-10-02','Prague, Czech Republic','https://sigops.org/s/conferences/sosp/2026/','AoE'],
['oopsla','OOPSLA',2026,1,'2025-10-10','','','','2026-02-17','','2026-10-03','2026-10-09','Oakland, CA, USA','https://2026.splashcon.org/track/splash-2026/oopsla-2026','AoE'],
['oopsla','OOPSLA',2026,2,'2026-03-17','','','','2026-06-10','2026-08-14','2026-10-03','2026-10-09','Oakland, CA, USA','https://2026.splashcon.org/track/splash-2026/oopsla-2026','AoE'],
['issta','ISSTA',2026,1,'2026-01-29','','','','2026-04-15','','2026-09-21','2026-09-25','Nanjing, China','https://conf.researchr.org/home/issta-2026','AoE'],
['dac','DAC',2026,1,'2026-01-20','','','','2026-03-01','','2026-07-26','2026-07-29','Long Beach, CA, USA','https://dac.com/2026','AoE']],
'2026submit-2027conf': [
